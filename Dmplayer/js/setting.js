var YZM = {
		...
		'con_play':function(){
			if (!danmuon) {	
       		...
       		//var conplayer = ` <e>已播放至${YZM.ctime}，继续上次播放？</e><d class="conplay-jump">是 <i id="num">${YZM.waittime}</i>s</d><d class="conplaying">否</d>`
				var conplayer = '<e>检测到您上次播放，您是否继续上次播放？</e><d class="conplay-jump">是 <i id="num">' + YZM.waittime + '</i>s</d><d class="conplaying">否</d>';
	...
	'danmu':{
		...
		var liyih='<div class="dmrules"><a target="_blank" href="http://api.ymcx.shop/">解析系统 </a></div>';
