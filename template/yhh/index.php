...
<link rel='stylesheet' href='./template/yhh/css/bootstrap.min.css'>

<link rel="stylesheet" href="./template/yhh/css/style.css">
...
<nav data-state="closed">
	<ul>
		...
		<li><a href="http://yb.jiexigu.com/?url=https://v.qq.com/x/cover/dxd1v76tmu0wjuj.html">接口测试</a></li>
	</ul>
</nav>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <h1>API</h1>
        <h2>解析计费系统</h2>
        <p>支持支持优酷视频、土豆视频、爱奇艺视频、芒果视频、乐视影视、腾讯视频、搜狐视频、PPTV视频、M1905电影网、咪咕视频，并且支持抖音、火山、头条、快手、梨视频、美拍、陌陌、皮皮搞笑、皮皮虾解析。仅支持学习交流,勿用非法用途!。
        </p>
        <a href="./user" class="btn green">登陆</a>
      </div>
    </div>
  </div>
</main>

<script src='./template/yhh/js/gsap.min.js'></script>
<script src="./template/yhh/js/script.js"></script>
